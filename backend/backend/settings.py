...
SECRET_KEY = os.environ.get('SECRET_KEY', 'maCleSecretePourLeDev')
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('POSTGRES_USER', 's4liou'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 's4liou@1234'),
